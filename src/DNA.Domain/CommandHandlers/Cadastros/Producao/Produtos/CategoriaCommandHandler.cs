...
namespace DNA.Domain.CommandHandlers.Cadastros.Producao.Produtos
{
...

    {
        ...
        public Task<bool> Handle(RegisterNewCategoriaCommand message, CancellationToken cancellationToken)
        {
            ...
            if (Commit())
            {
                Bus.RaiseEvent(new CategoriaRegisteredEvent(categoria.Id, categoria.Descricao));
            }
        ...
        public Task<bool> Handle(UpdateCategoriaCommand message, CancellationToken cancellationToken)
        {
            ...
            if (Commit())
            {
                Bus.RaiseEvent(new CategoriaUpdatedEvent(categoria.Id, categoria.Descricao));
            }
