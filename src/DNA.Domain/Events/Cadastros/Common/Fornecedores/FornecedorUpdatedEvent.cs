...
namespace DNA.Domain.Events.Cadastros.Common.Fornecedores
{
    ...
    {
        public FornecedorUpdatedEvent(Guid id, string nomeCompanhia, string nomeContato, string tituloContato, string telefone, string enderecoEmail, string endereco, string cidade, string estado, string pais)
        {
            Id = id;
